        ...
        <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
            <thead>
                <tr>
                    ...
                    <th title="Field #2">uuid</th>
                    <th title="Field #3">Nominativo</th>
                    <th title="Field #4">Email</th>
                    {{-- <th title="Field #5">T.Fisso</th>
                    <th title="Field #6">T.Mobile</th> --}}
                    <th title="Field #7">P.Iva</th>
                    <th title="Field #8">Azioni</th>
                </tr>
            </thead>
